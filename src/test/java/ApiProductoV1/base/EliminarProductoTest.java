...
public class EliminarProductoTest extends ApiConfig{
	...
	public void eliminarProducto() {
		...
		OnStage.theActorInTheSpotlight().should(
				ResponseConsequence.seeThatResponse("El mensaje retornado debe ser El producto fue eliminado con éxito"
						,response -> response.body("message", containsString("El producto fue eliminado con éxito")))
				);
