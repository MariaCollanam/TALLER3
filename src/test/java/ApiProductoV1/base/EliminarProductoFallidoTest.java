...
@DisplayName("Requisito 6. Eliminar un producto Fallido previamente creado usando la api /api/v1/product/")
public class EliminarProductoFallidoTest extends ApiConfig{
	@BeforeEach
	...
	public void eliminarProducto() {
		...
		OnStage.theActorInTheSpotlight().should(
				ResponseConsequence.seeThatResponse("El codigo de la respuesta es 404",response -> response.statusCode(404))
		);
